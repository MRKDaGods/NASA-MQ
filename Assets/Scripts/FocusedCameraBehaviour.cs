...
namespace MRK
{
    public class FocusedCameraBehaviour : CameraBehaviour
    {
        ...
        public FocusedCameraBehaviour(Transform moon, Camera camera) : base(moon, camera)
        {
        }
        ...
        public override void OnEnabled()
        {
            ...
            DOTween.To(() => RenderSettings.ambientLight, x => RenderSettings.ambientLight = x, Color.white, 0.3f);
            DOTween.To(() => RenderSettings.sun.intensity, x => RenderSettings.sun.intensity = x, 0.5f, 0.3f);
        }

        public override void OnDisabled()
        {
            DOTween.To(() => RenderSettings.ambientLight, x => RenderSettings.ambientLight = x, new Color32(50, 50, 50, 255), 0.3f);
            DOTween.To(() => RenderSettings.sun.intensity, x => RenderSettings.sun.intensity = x, 1.3f, 0.3f);
        }
